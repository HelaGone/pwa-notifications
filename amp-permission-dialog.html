...
<!-- saved from url=(0072)https://cdn.onesignal.com/sdks/amp-distribute/amp-permission-dialog.html -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
  ...
  <div id="postload" class="">
    <span id="close"></span>
    <div permission="default" class="invisible">
      <p class="message">
        <!--
...
<script type="text/javascript">(function(){var f,h=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a}(this);function l(a,b){b=void 0===b?"":b;try{return decodeURIComponent(a)}catch(d){return b}};var m=/(?:^[#?]?|&)([^=&]+)(?:=([^&]*))?/g;Date.now();self.log=self.log||{user:null,dev:null,userForEmbed:null};var n,p;
...
function y(a){a.requestNotificationPermission().then(function(b){w(a);if(a.isCurrentDialogPopup())return a.o.connect(opener,"*"),a.o.send(t.Topics.NOTIFICATION_PERMISSION_STATE,b).then(function(b){var c=b[0];c&&c.closeFrame&&a.closeDialog()});a.closeDialog()})}f.redirectToUrl=function(a){var b=q(a);"string"===typeof a&&a.startsWith("http")&&b&&b.origin===location.origin&&(this.a.location.href=a)};window._ampWebPushPermissionDialog=new u({debug:!1});window._ampWebPushPermissionDialog.run();})();
